...
public class PortalFlowerBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:portal_flower")
	public static final Block block = null;
	public PortalFlowerBlock(DereniumModElements instance) {
		super(instance, 28);
	}
