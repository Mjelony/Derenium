...
public class MangroveLogBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:mangrove_log")
	public static final Block block = null;
	public MangroveLogBlock(DereniumModElements instance) {
		super(instance, 63);
	}
