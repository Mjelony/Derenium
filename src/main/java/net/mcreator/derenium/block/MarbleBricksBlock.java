...
public class MarbleBricksBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:marble_bricks")
	public static final Block block = null;
	public MarbleBricksBlock(DereniumModElements instance) {
		super(instance, 42);
	}
