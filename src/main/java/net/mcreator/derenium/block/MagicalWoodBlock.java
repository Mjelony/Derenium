...
public class MagicalWoodBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:magical_wood")
	public static final Block block = null;
	public MagicalWoodBlock(DereniumModElements instance) {
		super(instance, 66);
	}
