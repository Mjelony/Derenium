...
public class MagicalLeavesBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:magical_leaves")
	public static final Block block = null;
	public MagicalLeavesBlock(DereniumModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magical_leaves");
		}
