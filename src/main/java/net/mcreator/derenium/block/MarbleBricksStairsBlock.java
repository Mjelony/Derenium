...
public class MarbleBricksStairsBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:marble_bricks_stairs")
	public static final Block block = null;
	public MarbleBricksStairsBlock(DereniumModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_bricks_stairs");
		}
