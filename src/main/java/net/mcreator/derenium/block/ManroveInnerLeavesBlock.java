...
public class ManroveInnerLeavesBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:manrove_inner_leaves")
	public static final Block block = null;
	public ManroveInnerLeavesBlock(DereniumModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("manrove_inner_leaves");
		}
