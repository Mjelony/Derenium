...
public class FancyBricksBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:fancy_bricks")
	public static final Block block = null;
	public FancyBricksBlock(DereniumModElements instance) {
		super(instance, 59);
	}
