...
public class RubyOreBlockBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(DereniumModElements instance) {
		super(instance, 3);
	}
