...
public class LilyFlowerBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:lily_flower")
	public static final Block block = null;
	public LilyFlowerBlock(DereniumModElements instance) {
		super(instance, 32);
	}
