...
import net.mcreator.derenium.item.RiceGrainItem;
...
public class RicePlantBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:rice_plant")
	public static final Block block = null;
	public RicePlantBlock(DereniumModElements instance) {
		super(instance, 26);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RiceGrainItem.block, (int) (1)));
		}
