...
import net.mcreator.derenium.item.RubyGemItem;
...
public class RubyOreBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(DereniumModElements instance) {
		super(instance, 2);
	}
