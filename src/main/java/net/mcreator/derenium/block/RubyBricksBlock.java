...
public class RubyBricksBlock extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:ruby_bricks")
	public static final Block block = null;
	public RubyBricksBlock(DereniumModElements instance) {
		super(instance, 23);
	}
