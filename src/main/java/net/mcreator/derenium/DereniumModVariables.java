...
public class DereniumModVariables {
	public DereniumModVariables(DereniumModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote) {
			...
			if (mapdata != null)
				DereniumMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "derenium_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				DereniumMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "derenium_mapvars";
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (!world.getWorld().isRemote)
				DereniumMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
