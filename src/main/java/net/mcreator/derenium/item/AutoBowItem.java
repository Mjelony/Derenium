...
public class AutoBowItem extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:auto_bow")
	public static final Item block = null;
	@ObjectHolder("derenium:entitybulletauto_bow")
	public static final EntityType arrow = null;
	public AutoBowItem(DereniumModElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(DereniumItemGroup.tab).maxDamage(1561));
