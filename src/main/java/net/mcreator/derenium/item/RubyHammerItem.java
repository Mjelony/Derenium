...
public class RubyHammerItem extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:ruby_hammer")
	public static final Item block = null;
	public RubyHammerItem(DereniumModElements instance) {
		super(instance, 49);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Sometimes works properly [W.I.P.]"));
			}
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					RubyHammerBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					RubyHammerRightClickedInAirProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("ruby_hammer"));
	}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
			...
			if (equipmentSlot == EquipmentSlotType.MAINHAND) {
				...
				multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(),
						new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", -3.9, AttributeModifier.Operation.ADDITION));
			}
			return multimap;
		}
