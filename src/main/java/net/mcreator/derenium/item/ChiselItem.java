...
public class ChiselItem extends DereniumModElements.ModElement {
	@ObjectHolder("derenium:chisel")
	public static final Item block = null;
	public ChiselItem(DereniumModElements instance) {
		super(instance, 60);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(DereniumItemGroup.tab).maxDamage(131));
		}
