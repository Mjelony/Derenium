...
public class Mangrove1Structure extends DereniumModElements.ModElement {
	public Mangrove1Structure(DereniumModElements instance) {
		super(instance, 69);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("derenium", "mangrove1"));
						if (template == null)
							return false;
