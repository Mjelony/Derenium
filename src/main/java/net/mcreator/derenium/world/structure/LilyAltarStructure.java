...
package net.mcreator.derenium.world.structure;
...
public class LilyAltarStructure extends DereniumModElements.ModElement {
	public LilyAltarStructure(DereniumModElements instance) {
		super(instance, 34);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("derenium", "lily_altar"));
						if (template == null)
							return false;
