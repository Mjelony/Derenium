...
public class TreasureStructure extends DereniumModElements.ModElement {
	public TreasureStructure(DereniumModElements instance) {
		super(instance, 43);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 2000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("derenium", "dungeon"));
						if (template == null)
							return false;
